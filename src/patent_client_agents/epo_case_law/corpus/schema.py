"""SQLite schema for the CASELAW corpus.

One ``sections`` row per CASELAW section (or appendix sub-part). The FTS5
...
META_KEYS = {
    ...
    "source_version": "CASELAW version label as reported by eCASELAW",
