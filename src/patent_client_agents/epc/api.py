...
from .models import EpcSearchResponse, EpcSection, EpcVersion
...
class SectionInput(BaseModel):
    """Input for getting an EPC section.
...
def _warn_client_deprecated() -> None:
    warnings.warn(
        ...
        "Use 'async with EpcClient() as client:' instead.",
        DeprecationWarning,
        stacklevel=3,
    )
